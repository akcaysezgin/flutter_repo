import 'package:mvvm_bloc/src/commons/widget/drop_down.dart';
import 'package:mvvm_bloc/src/commons/widget/text_input.dart';
...
Future<dynamic> createDialog({
  ...
  required void Function(UserModel) userData,
