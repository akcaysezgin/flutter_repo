...
import 'package:mvvm_bloc/src/constants/app_extension.dart';

import '../../../../../core/bloc/bloc_helper.dart';
import '../../../../../core/bloc/generic_bloc_state.dart';
import '../../../../../core/dialog/create_dialog.dart';
import '../../../../../core/dialog/delete_dialog.dart';
import '../../../../../core/dialog/progress_dialog.dart';
import '../../../../../core/dialog/retry_dialog.dart';
import '../../../../../commons/widget/empty_widget.dart';
import '../../../../../commons/widget/popup_menu.dart';
import '../../../../../commons/widget/spinkit_indicator.dart';
    ...
    return FloatingActionButton(
      onPressed: () async {
        ...
        bool isCreate = await createDialog(
          context: context,
          userData: (userValue) => user = userValue,
        );
          ...
          showDialog(
            ...
            builder: (_) {
              return BlocBuilder<UserBloc, GenericBlocState<UserModel>>(
                builder:
                    (BuildContext context, GenericBlocState<UserModel> state) {
                  switch (state.status) {
                    case Status.empty:
  ...
  void deleteUser(UserModel user) async {
    ...
    if (isAccepted) {
      ...
      showDialog(
        ...
        builder: (_) {
          return BlocBuilder<UserBloc, GenericBlocState<UserModel>>(
            builder: (BuildContext context, GenericBlocState<UserModel> state) {
              switch (state.status) {
                case Status.empty:
                  return const SizedBox();
                case Status.loading:
